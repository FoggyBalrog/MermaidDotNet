...
Vertical markers can be added to the diagram with the `AddVerticalMarker` method. They require a strict target of **11.7 or later**; see [version compatibility](../compatibility.md).
