...
public class GanttDiagramValidationAndSanitizationOptionsTests
{
    ...
    public void SanitizeInputs()
    {
        ...
        Assert.Contains("Task#58;1: task1", diagram);
        Assert.Contains("Task#58;2: task2", diagram);
        Assert.Contains("section Section#58;1", diagram);
        Assert.Contains("Mark#58;1: vert", diagram);
        Assert.Contains("click task1 call fn#32;name()", diagram);
