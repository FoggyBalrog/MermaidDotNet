...
public class FlowchartDefaultOptionsValidationTests
{
    [Fact]
    ...
    [Fact]
    public void AddHyperlink_ThrowsIfUriIsInvalid()
    {
        var exception = Assert.Throws<MermaidException>(() =>
        {
            Mermaid
                .Flowchart()
                .AddNode("node", out var node)
                .AddHyperlink(node, "http://example.com\\foo");
        });
    ...
    public void AddHyperlink_ThrowsIfTooltipIsWhiteSpace()
    {
        var exception = Assert.Throws<MermaidException>(() =>
        {
            Mermaid
                .Flowchart()
                .AddNode("node", out var node)
                .AddHyperlink(node, "https://foo.com", " ");
        });
