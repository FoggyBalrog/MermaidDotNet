...
- **Unchecked**: skips feature compatibility checks without disabling input validation or sanitization.
...
For unrestricted generation, set `CompatibilityMode = MermaidCompatibilityMode.Unchecked`. See the [compatibility reference](./docs/compatibility.md) for the feature matrix, migration guidance, and audit scope.
