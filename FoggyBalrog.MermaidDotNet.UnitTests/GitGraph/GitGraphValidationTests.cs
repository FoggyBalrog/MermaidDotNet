...
public class GitGraphValidationTests
{
    [Fact]
    ...
    // Tests for public GitGraphBuilder Merge(Branch branch, string? id = null, CommitType type = CommitType.Normal, string? tag = null)
    [Fact]
